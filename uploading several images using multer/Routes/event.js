...
const updateEventById = require('../Controller/event').updateEventById
...
router.put('/updateEventById/:id', upload.fields([{ name: 'image', maxCount: 1 }, { name: 'sImage', maxCount: 1 }, { name: 'sPhoto', maxCount: 1 }]), updateEventById)             //up and working
